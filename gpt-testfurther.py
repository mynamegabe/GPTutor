...
if len(sections) == 2:
    ...
    for question in lines[::6]:
        ...
        print(answers)
        print("RETURN 0: " + str([[questions[i], possible_answers[i], answers[i]] for i in range(len(answers))]))
...
print("============ ACTUAL ANSWERS ===================")
print(actualanswers)
print("RETURN: " + str([[questions[i], possible_answers[i], answers[i]] for i in range(len(answers))]))
